...
@section('content')
<form action="/know-me-more" method="POST"
	...
	<div class="grid h-10 grid-cols-1 mb-2 md:grid-cols-2 ">
		...
		<input type="text" name="link_img" id="link_img" class="p-2 bg-transparent border-b-2 border-slate-900">
	</div>
	<div class="grid h-10 grid-cols-1 mb-2 md:grid-cols-2">
		<label for="title">Title</label>
		<input type="text" name="title" id="title" class="p-2 bg-transparent border-b-2 border-slate-900">
	</div>
	<div class="grid h-10 grid-cols-1 mb-2 md:grid-cols-2">
		<label for="description">Description</label>
		<input type="text" name="description" id="description" class="p-2 bg-transparent border-b-2 border-slate-900">
	</div>
